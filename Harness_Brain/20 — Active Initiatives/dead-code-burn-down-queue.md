...
- [ ] **`run [if @887]`** · `scripts/doc_cite_adjacency.py` 888-903 · 16 · DECIDE (delete / field-only / untested live) · census: `scripts/doc_cite_adjacency.py:888-903 run [if @887] arm 16 lines, 0 hits` · S2 **TAKEN 2026-09-25 lane Q-DEAD-B**
- [ ] **`run [if @865]`** · `scripts/doc_cite_adjacency.py` 866-884 · 19 · DECIDE (delete / field-only / untested live) · census: `scripts/doc_cite_adjacency.py:866-884 run [if @865] arm 19 lines, 0 hits` · S2 **TAKEN 2026-09-25 lane Q-DEAD-B**
- [ ] **`_sys_modules_identity_is_restored [if @340]`** · `tests/_downstream/hermes_cli_conftest.py` 341-356 · 16 · DECIDE (delete / field-only / untested live) · census: `tests/_downstream/hermes_cli_conftest.py:341-356 _sys_modules_identity_is_restored [if @340] arm 16 lines, 0 hits` · T2 **TAKEN 2026-09-25 lane Q-DEAD-B**
- [ ] **`_git_name_only_ignores_cr_at_eol`** · `tests/_downstream/hermes_cli_conftest.py` 829-854 · 26 · DECIDE (delete / field-only / untested live) · census: `tests/_downstream/hermes_cli_conftest.py:829-854 _git_name_only_ignores_cr_at_eol function 26 lines, 0 hits` · T2 **TAKEN 2026-09-25 lane Q-DEAD-B**
- [ ] **`pytest_terminal_summary [if @1320]`** · `tests/_downstream/hermes_cli_conftest.py` 1321-1331 · 11 · DECIDE (delete / field-only / untested live) · census: `tests/_downstream/hermes_cli_conftest.py:1321-1331 pytest_terminal_summary [if @1320] arm 11 lines, 0 hits` · T2 **TAKEN 2026-09-25 lane Q-DEAD-B**
