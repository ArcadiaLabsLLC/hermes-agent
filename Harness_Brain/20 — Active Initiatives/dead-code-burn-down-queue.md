...
- [ ] **`cmd_gateway_pair [if @361]`** · `hermes_cli/harness_parts/gateway_commands.py` 365-376 · 12 · DECIDE (delete / field-only / untested live) · census: `hermes_cli/harness_parts/gateway_commands.py:365-376 cmd_gateway_pair [if @361] arm 12 lines, 0 hits` · R4 **TAKEN 2026-09-25 lane B2**
- [ ] **`_install_and_certificate [if @545]`** · `hermes_cli/harness_parts/gateway_commands.py` 546-557 · 12 · DECIDE (delete / field-only / untested live) · census: `hermes_cli/harness_parts/gateway_commands.py:546-557 _install_and_certificate [if @545] arm 12 lines, 0 hits` · R4 **TAKEN 2026-09-25 lane B2**
- [ ] **`_install_and_certificate [if @531]`** · `hermes_cli/harness_parts/gateway_commands.py` 532-543 · 12 · DECIDE (delete / field-only / untested live) · census: `hermes_cli/harness_parts/gateway_commands.py:532-543 _install_and_certificate [if @531] arm 12 lines, 0 hits` · R4 **TAKEN 2026-09-25 lane B2**
- [ ] **`cmd_gateway_introduce [if @1520]`** · `hermes_cli/harness_parts/gateway_commands.py` 1524-1535 · 12 · DECIDE (delete / field-only / untested live) · census: `hermes_cli/harness_parts/gateway_commands.py:1524-1535 cmd_gateway_introduce [if @1520] arm 12 lines, 0 hits` · R4 **TAKEN 2026-09-25 lane B2**
- [ ] **`cmd_gateway_peers_join [if @2024]`** · `hermes_cli/harness_parts/gateway_commands.py` 2025-2035 · 11 · DECIDE (delete / field-only / untested live) · census: `hermes_cli/harness_parts/gateway_commands.py:2025-2035 cmd_gateway_peers_join [if @2024] arm 11 lines, 0 hits` · R4 **TAKEN 2026-09-25 lane B2**
- [ ] **`cmd_gateway_peers_join [if @2011]`** · `hermes_cli/harness_parts/gateway_commands.py` 2012-2023 · 12 · DECIDE (delete / field-only / untested live) · census: `hermes_cli/harness_parts/gateway_commands.py:2012-2023 cmd_gateway_peers_join [if @2011] arm 12 lines, 0 hits` · R4 **TAKEN 2026-09-25 lane B2**
- [ ] **`cmd_gateway_peers_join [if @1992]`** · `hermes_cli/harness_parts/gateway_commands.py` 1993-2006 · 14 · DECIDE (delete / field-only / untested live) · census: `hermes_cli/harness_parts/gateway_commands.py:1993-2006 cmd_gateway_peers_join [if @1992] arm 14 lines, 0 hits` · R4 **TAKEN 2026-09-25 lane B2**
- [ ] **`cmd_gateway_peers_join [if @1829]`** · `hermes_cli/harness_parts/gateway_commands.py` 1830-1840 · 11 · DECIDE (delete / field-only / untested live) · census: `hermes_cli/harness_parts/gateway_commands.py:1830-1840 cmd_gateway_peers_join [if @1829] arm 11 lines, 0 hits` · R4 **TAKEN 2026-09-25 lane B2**
