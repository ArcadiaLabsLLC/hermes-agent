...
Sibling launcher/frontend child brain. Source-of-truth for the Mission Control SURFACE (office scene, chat panel, board, read model), the Flutter launcher, Stage C QA, and **the Mission Control work queue for both repos**.
...
- To file or claim runtime work: `20 — Active Initiatives/mission-control-queue.md`.
...
| runtime program cursors, hermes-side handoffs | Mission Control queue rows (both repos) |
