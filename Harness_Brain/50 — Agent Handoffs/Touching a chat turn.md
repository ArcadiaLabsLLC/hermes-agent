...
- Ledger: `agent_runtime/mission_chat_turns/`; live log `agent_runtime/chat_live_log/`; history/curation `persona_chat_history.py`; continuity (clarify tickets, mint receipts) `persona_chat_continuity.py`.
