...
| data + shapes | `snapshot.py` (the core), `core_cache.py` (fingerprint cache), `state_patches.py`, `events.py`, `serde.py` (one authority for wire coercion + atomic JSON), `paths.py` | [02](../../docs/agent-runtime-harness/02-runtime-data-and-shapes.md) |
