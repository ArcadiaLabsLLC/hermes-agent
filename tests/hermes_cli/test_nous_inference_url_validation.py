...
class TestEnvOverrideWins:
    ...
    def _patch_no_refresh(self, monkeypatch, auth, state):
        ...
        monkeypatch.setattr(auth, "sync_nous_pool_from_auth_store", lambda *a, **k: None)
        monkeypatch.setattr(hermes_cli_auth_nous, "sync_nous_pool_from_auth_store", lambda *a, **k: None)
