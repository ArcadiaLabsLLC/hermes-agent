...
class TestBuildContextFilesPrompt:
    ...
    # Fork: project context sources are ADDITIVE (deterministic context
    # sources), not a first-match-wins priority chain — which is why upstream's
    # `*_beats_*` cases have no counterpart here.
