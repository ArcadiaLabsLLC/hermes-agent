...
class TestBuildSafeEnv:
    ...
    def test_windows_location_vars_passed_without_secrets(self):
        ...
        # os.environ upper-cases every key it stores there, so "ProgramFiles"
        # comes back out of _build_safe_env as "PROGRAMFILES" (which is why
        # _build_safe_env matches on key.upper()). Pin the guarantee - the
        # variable is passed through with its value, the secrets are not -
