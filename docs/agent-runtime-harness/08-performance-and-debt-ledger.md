...
(`serve.py:1752`; renamed from `_ReadModelCache` in the duplicate-implementation
...
- Two of its six defect classes were re-checked and are **LANDED, so they are dropped
  ...
  (`agent_runtime/stream.py:572`, with the mechanism written out at `:892`), and RD-H1's
